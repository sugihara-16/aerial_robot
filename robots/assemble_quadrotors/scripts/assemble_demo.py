    ...
    def main(self):
        ...
        while not rospy.is_shutdown():
            ...
            while not rospy.is_shutdown():
                ...
                nav_msg_male.target_pos_x = female_pos[0] - 1.0
                nav_msg_male.target_pos_y = female_pos[1]
                nav_msg_male.target_pos_z = female_pos[2]
                nav_msg_male.target_yaw = female_euler[2] - 3.141592
